...
export default function AdminLoginPage() {
  return (
    <div
      className="min-h-screen overflow-hidden flex items-center justify-center bg-gradient-to-br
    ...
    >
      ...
      />
      {/* blurred blobs */}
      <div className="absolute -top-32 -left-32 w-96 h-96 rounded-full bg-indigo-300 opacity-40 blur-3xl" />
      <div className="absolute -bottom-40 right-0 w-[28rem] h-[28rem] rounded-full bg-cyan-200 opacity-40 blur-3xl" />
